...
function respostaSelecionada(opcaoSelecionada) {
    const afirmacoes = aleatorio(opcaoSelecionada.afirmacao);//adiciona aleatorio para pegar uma informação aleatoriamente
...
//essa função vai receber uma lista. A função vai ler os argumentos e selecionar um nº aleatório além de armazena-lo em uma constante
function aleatorio(lista){
    const posicao = Math.floor(Math.random()* lista.length);//aqui cria o valor aleatório
    return lista[posicao]; //retorna o valor gerado na const posicao
}
